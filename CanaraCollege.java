public class CanaraCollege extends CollegeDetails{
	
	int numberOfDepartments;
	int numberOfClassRooms;

	public CanaraCollege(HeadOfDepartment[] hod, Principal principal, Students[] student, Professors[] professors, int numberOfDepartments, int numberOfClassRooms){
	...
	public void printDetails(){
		...
		System.out.println(".....CANARA COLLEGE DETAILS...");
