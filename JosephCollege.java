public class JosephCollege extends CollegeDetails{
	
	int numberOfFestivals;
	

	public JosephCollege(HeadOfDepartment[] hod, Principal principal, Students[] student, Professors[] professors, int numberOfFestivals){
	...
	public void printDetails(){
		...
		System.out.println("...JOSEPH COLLEGE DETAILS...");
